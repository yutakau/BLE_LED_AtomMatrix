// for M5Stick ATOM Matrix (5x5 LED)
//
// 2023/6/30 Y.Usui

// Changed LED control library from FastLed to M5Atom.
// FastLED appears to work correctly, but the last blue pixel is missing.
//
...
// BLE上のこのデバイスの名前
//#define BLE_LOCAL_NAME "ATOM#2"
// BLEのサービスUUID
//#define BLE_SERVICE_UUID "d000c0a6-17d4-11ee-be56-0242ac120002"
// BLEのCharacteristic UUID
//#define BLE_CHARACTERISTIC_BTN_UUID "d000c39e-17d4-11ee-be56-0242ac120002"
//#define BLE_CHARACTERISTIC_LED_UUID "d000c4e8-17d4-11ee-be56-0242ac120002"
...
void loop() {
  ...
  if (ble_write){
    for(int j=0; j<LED_NUMBER; j++) {
      M5.dis.drawpix(j, ledbuf[2]<<16 | ledbuf[1] <<8 | ledbuf[0] );  
    }
    //FastLED.show();      
    ble_write = false;
  }
